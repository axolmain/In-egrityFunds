...
const BudgetSummary: React.FC<BudgetSummaryProps> = ({ transactions, timePeriod }) => {
    // Calculate total spent
    const totalSpent: number = transactions.reduce((sum, transaction) => sum + transaction.amount, 0);
    ...
    return (
        <div className="p-4 bg-white shadow-md rounded-md">
            <h3 className="text-lg font-semibold mb-4">Budget Summary ({timePeriod})</h3>
