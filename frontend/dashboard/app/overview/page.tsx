        ...
        <div className="container mx-auto px-4 py-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-8">
                ...
                <div className="col-span-1 lg:col-span-1">
                    <BudgetSummary transactions={transactions} timePeriod={selectedTimePeriod} />
                </div>

                {/* Spending Categories Pie Chart */}
                <div className="col-span-1 lg:col-span-1">
                    <SpendingCategories transactions={transactions} timePeriod={selectedTimePeriod} />
                </div>
            ...
            <div className="mt-8">
                ...
                <SpendingTrendsChart transactions={transactions} timePeriod={selectedTimePeriod} />
            </div>
